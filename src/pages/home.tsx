      ...
      <section className="relative min-h-[92dvh] overflow-hidden bg-[#F5F5F5]">
        ...
        <div className="relative mx-auto flex min-h-[92dvh] max-w-[1440px] items-center justify-center px-6 pt-28 md:px-10 lg:px-14">
          <div className="reveal text-center">
            ...
            <p className="mx-auto mt-8 max-w-[480px] text-[20px] leading-8 text-[#111111]">IS Wealth Advisors es una firma especializada en el asesoramiento financiero<br />y patrimonial de grandes patrimonios, familias e instituciones.</p>
          </div>
        </div>
