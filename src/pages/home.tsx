...
const ArrowLink = ({ href, children }: { href: string; children: string }) => (
  <Link href={href} data-testid={`link-${children.toLowerCase().replaceAll(" ", "-")}`} className="group inline-flex border-b border-[#111111]/35 pb-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#111111]">
    ...
    <div>
      ...
      <section className="relative min-h-[92dvh] overflow-hidden bg-[#F5F5F5]">
        ...
        <div className="relative mx-auto flex min-h-[92dvh] max-w-[1440px] items-center justify-center px-6 pt-28 md:px-10 lg:px-14">
          <div className="reveal text-center">
            ...
            <p className="mx-auto mt-8 max-w-[900px] text-[20px] leading-8 text-[#111111]">IS Wealth Advisors es una firma especializada en el asesoramiento<br />financiero y patrimonial de grandes patrimonios, familias e instituciones.</p>
          </div>
        </div>
      ...
      <section className="px-6 py-20 md:px-10 md:py-28 lg:px-14">
        <div className="mx-auto grid max-w-[1440px] items-center gap-10 md:grid-cols-12 md:gap-14">
          ...
          <div className="md:col-span-6 md:col-start-7">
            <p className="text-[12px] font-semibold uppercase leading-none tracking-[0.2em] text-[#111111]/65">Banca privada</p>
            <h2 className="mt-4 text-[clamp(32px,4vw,48px)] font-normal leading-[1.04] tracking-[-0.065em]">Agentes de Singular Bank</h2>
            <p className="mt-7 max-w-[580px] text-[17px] leading-7 text-[#000000]/65">IS Wealth Advisors opera como agente financiero de Singular Bank, la banca privada independiente líder en España, con sólida presencia internacional.</p>
            <p className="mt-4 max-w-[580px] text-[17px] leading-7 text-[#000000]/65">Esta vinculación da acceso a su plataforma de inversión, sus servicios bancarios y soluciones de inversión, financiación y corporate advisory.</p>
            <p className="mt-4 max-w-[580px] text-[17px] leading-7 text-[#000000]/65">Las decisiones sobre cada patrimonio se toman de forma independiente: conocemos a nuestros clientes, entendemos sus necesidades y les asesoramos sin estar supeditados a objetivos comerciales predefinidos.</p>
      ...
      <section className="border-t border-[#D7D6D1] px-6 py-16 md:px-10 md:py-24 lg:px-14">
        <div className="mx-auto max-w-[1440px]">
          ...
          <h2 className="max-w-[760px] text-[clamp(32px,4.2vw,60px)] font-medium leading-[.98] tracking-[-0.07em]">Más de 25 años en banca privada.</h2>
          <div className="mt-12 grid gap-10 md:grid-cols-2">
             <Link href="/socios/christian-izquierdo-abadia" data-testid="link-christian" className="group relative block aspect-[1.05] overflow-hidden"><img src="/images/christian.png" alt="Christian Izquierdo Abadía" className="editorial-image h-full w-full object-contain transition-transform duration-300 group-hover:scale-105" /><div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 to-transparent p-5 pt-16"><p className="text-[16px] font-medium text-white">Christian Izquierdo Abadía</p><p className="text-[13px] text-white/75">Socio Fundador</p></div></Link>
             <Link href="/socios/angel-sanz-de-ayala" data-testid="link-angel" className="group relative block aspect-[1.05] overflow-hidden md:mt-24"><img src="/images/angel.png" alt="Ángel Sanz de Ayala" className="editorial-image h-full w-full object-contain transition-transform duration-300 group-hover:scale-105" /><div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 to-transparent p-5 pt-16"><p className="text-[16px] font-medium text-white">Ángel Sanz de Ayala</p><p className="text-[13px] text-white/75">Socio Fundador</p></div></Link>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 md:px-10 md:py-28 lg:px-14">
        <div className="mx-auto max-w-[1440px]">
          <div className="grid items-center gap-10 md:grid-cols-12">
            <div className="md:col-span-5"><p className="mb-5 text-[10px] uppercase tracking-[0.2em] text-[#111111]/55">Nuestro enfoque</p><h2 className="text-[clamp(29px,3.6vw,50px)] font-medium leading-[1.04] tracking-[-0.065em]">Conocimiento profundo del cliente.</h2></div>
            <div className="md:col-span-6 md:col-start-7"><p className="text-[16px] leading-7 text-[#111111]/65">Su socio en IS Wealth Advisors es su interlocutor directo, respaldado por los equipos de especialistas necesarios. Entendemos que cada patrimonio es único y requiere un asesoramiento personalizado, adaptado a sus objetivos, valores y visión del futuro.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-[#D7D6D1] bg-[#E8E7E3] px-6 py-16 md:px-10 md:py-24 lg:px-14">
        <div className="mx-auto grid max-w-[1440px] items-center gap-10 md:grid-cols-12 md:gap-14">
          ...
          <div className="md:col-span-6 md:col-start-7">
            ...
            <p className="mt-5 max-w-[560px] text-[15px] leading-7 text-[#111111]/65">Entendemos el asesoramiento como una relación de confianza basada en el máximo conocimiento del cliente, la disponibilidad para escuchar y el rigor analítico.</p>
            <ul className="mt-8 max-w-[520px]">
