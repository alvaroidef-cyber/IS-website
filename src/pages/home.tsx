    ...
    <div>
      ...
      <section className="relative min-h-[92dvh] overflow-hidden bg-[#0B1728] text-[#F7F7F5]">
        <div className="absolute inset-0">
          <img src="/images/Captura_de_Pantalla_2026-09-09_a_las_11.18.57.png" alt="Paisaje de montaña nevada" className="editorial-image h-full w-full object-cover" style={{ filter: "grayscale(1)" }} />
        </div>
      ...
      <section className="border-t border-[#D7D6D1] px-6 py-16 md:px-10 md:py-24 lg:px-14">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-12 grid gap-10 md:grid-cols-2">
             <Link href="/socios/christian-izquierdo-abadia" data-testid="link-christian" className="group"><div className="aspect-[3/4] overflow-hidden"><img src="/images/christian.png" alt="Christian Izquierdo Abadía" className="editorial-image h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" /></div><p className="mt-4 text-[16px] font-medium">Christian Izquierdo Abadía</p><p className="text-[13px] text-[#111111]/65">Socio Fundador</p></Link>
             <Link href="/socios/angel-sanz-de-ayala" data-testid="link-angel" className="group md:mt-24"><div className="aspect-[3/4] overflow-hidden"><img src="/images/angel.png" alt="Ángel Sanz de Ayala" className="editorial-image h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" /></div><p className="mt-4 text-[16px] font-medium">Ángel Sanz de Ayala</p><p className="text-[13px] text-[#111111]/65">Socio Fundador</p></Link>
          </div>
        </div>
      </section>
